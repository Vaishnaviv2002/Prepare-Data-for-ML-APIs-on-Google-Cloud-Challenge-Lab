...
echo " Welcome Vaishnavi "
echo "${TXT_RESET}"

echo "${CLR_YELLOW}${TXT_BOLD}Repository:${TXT_RESET} https://github.com/Vaishnaviv2002/Prepare-Data-for-ML-APIs-on-Google-Cloud-Challenge-Lab"
echo
